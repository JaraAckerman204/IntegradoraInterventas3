// ==========================================
// 📄 cocina-reposteria.page.ts - PÁGINA DE COCINA Y REPOSTERÍA CON FILTROS Y TOAST SERVICE
// ==========================================
    ...
    this.productosService.getProductos().subscribe({
      next: (productos) => {
        ...
        if (this.products.length === 0) {
          this.mostrarToast('ℹ️ No se encontraron productos de cocina y repostería');
        }
      },
      error: (error) => {
        clearTimeout(timeoutId);
