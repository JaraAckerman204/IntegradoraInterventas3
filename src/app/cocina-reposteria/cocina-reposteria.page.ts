...
import { 
  ...
  closeCircleOutline,
  chevronUpOutline,
  bagHandleOutline, restaurantOutline } from 'ionicons/icons';
...
export class CocinaReposteriaPage implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    addIcons({restaurantOutline,layersOutline,ribbonOutline,albumsOutline,colorPaletteOutline,resizeOutline,checkmarkCircleOutline,leafOutline,radioOutline,snowOutline,closeCircleOutline,refreshOutline,eyeOutline,chevronBackOutline,chevronForwardOutline,closeOutline,barcodeOutline,informationCircleOutline,cubeOutline,documentTextOutline,bulbOutline,cartOutline,chevronDownOutline,storefrontOutline,removeOutline,addOutline,cart,businessOutline,pricetagOutline,linkOutline,appsOutline,chevronUpOutline,bagHandleOutline});
  }
  ...
  loadProducts() {
    ...
    this.productosService.getProductos().subscribe({
      next: (productos) => {
        ...
        // ⭐ FILTRAR SOLO COCINA Y REPOSTERÍA
        this.products = productos.filter(p => {
          ...
          return (categoria.includes('cocina') && categoria.includes('reposteria')) ||
                 (categoria.includes('cocina') && categoria.includes('repostería'));
        });
        
        console.log('🍰 Productos de Cocina y Repostería filtrados:', this.products.length);
  ...
  extractFilters() {
    ...
    console.log('🎨 Filtros extraídos para cocina y repostería:', {
