// ==========================================
// 📄 higienicos-servilletas.page.ts - CON FILTROS, PAGINACIÓN Y TOAST SERVICE
// ==========================================
...
export class HigienicosServilletasPage implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    console.log('✅ Página de Higiénicos y Servilletas inicializada');
    this.loadProducts();
  ...
  // =============================
  loadProducts() {
    console.log('📄 Iniciando carga de higiénicos y servilletas...');
    this.loading = true;
    this.products = [];
    ...
    this.productosService.getProductos().subscribe({
      next: (productos) => {
        ...
        // ⭐ FILTRAR SOLO HIGIÉNICOS Y SERVILLETAS
        ...
        console.log('🧻 Productos de Higiénicos y Servilletas filtrados:', this.products.length);
        ...
        if (this.products.length === 0) {
          this.mostrarToast('ℹ️ No se encontraron productos de higiénicos y servilletas');
        }
      },
      error: (error) => {
        clearTimeout(timeoutId);
  ...
  extractFilters() {
    ...
    console.log('🎨 Filtros extraídos para higiénicos y servilletas:', {
